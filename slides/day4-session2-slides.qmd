...
**Task**: Build Excel model for Case 2 NPV calculation

**Requirements:**
1. Create assumptions section with all inputs
2. Build year-by-year cash flow projections
3. Calculate NPV using real method
4. Test sensitivity to wage inflation rate
5. Format professionally

**Extension**: Calculate nominal method NPV and compare results

**Support Available**: Walk around to help with Excel formulas and logic

## Exercise Debrief and Discussion

**Share Your Results:**
- What NPV did you calculate?
- How sensitive is the project to wage inflation changes?
- What challenges did you encounter?

**Key Learning Points:**
- Importance of systematic approach
- Value of sensitivity analysis for risk assessment
- Professional presentation standards

**Connection to Assessment**: These skills directly apply to coursework Case 2 requirements
...
- Major coursework component (40% of marks)

**Lunch Break**: 75 minutes to process this technical content and prepare for regulatory analysis

**Return at 2:00 PM ready to tackle legal and compliance challenges!**